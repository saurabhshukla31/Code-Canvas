...
export default function App() {
  ...
  return (
    <>
      <MetaViewport />
      <div className="h-screen bg-[#0c0c0d] text-zinc-100 flex flex-col">
        <Header />
